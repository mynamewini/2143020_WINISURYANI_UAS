            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-header">
                        <a href="{{ route('operator.aspirations.index') }}" class="btn btn-primary float-end">Kembali</a>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    {{-- Form Reply --}}
                                    <form action="{{ route('operator.aspirations.update', $aspiration->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <td>
                                            {{-- update_at --}}
