                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('operator.orders.index', ['user' => Auth::user()->id]) }}">Pesanan</a></li>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form
                                                action="{{ route('operator.orders.updateShipping', ['user' => Auth::user()->id, 'order' => $order->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="{{ route('operator.orders.updateAdminNotes', ['user' => Auth::user()->id, 'order' => $order->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($order->payment_status == 'pending')
                                                <form
                                                    action="{{ route('operator.orders.confirmPayment', ['user' => Auth::user()->id, 'order' => $order->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PATCH')
